...
CREATE TABLE aps.dbo.Usuario ( id int IDENTITY(1,1) NOT NULL, usuarioAuditor nvarchar(255) COLLATE Modern_Spanish_CI_AS NOT NULL, fechaCreacion datetime2 NOT NULL, fechaActualizacion datetime2 NOT NULL, nombre varchar(50) COLLATE Modern_Spanish_CI_AS NOT NULL, apellido varchar(50) COLLATE Modern_Spanish_CI_AS NOT NULL, contraseña nvarchar(255) COLLATE Modern_Spanish_CI_AS NOT NULL, nombreUsuario varchar(50) COLLATE Modern_Spanish_CI_AS NOT NULL, correo varchar(100) COLLATE Modern_Spanish_CI_AS NOT NULL, telefono varchar(15) COLLATE Modern_Spanish_CI_AS NOT NULL, activo bit NOT NULL, token nvarchar(255) COLLATE Modern_Spanish_CI_AS NULL, AesIV varchar(30) COLLATE Modern_Spanish_CI_AS NOT NULL, CONSTRAINT PK_925c3fc5494373e254405c000eb PRIMARY KEY (id), CONSTRAINT UQ_2242ae6c8b6db1061bd394bc9fd UNIQUE (nombreUsuario), CONSTRAINT UQ_631bf87f4acdcb87c6ff8648c37 UNIQUE (correo));
...
CREATE TABLE aps.dbo.EmpresaCredenciales ( id int IDENTITY(1,1) NOT NULL, usuarioAuditor nvarchar(255) COLLATE Modern_Spanish_CI_AS NOT NULL, fechaCreacion datetime2 NOT NULL, fechaActualizacion datetime2 NOT NULL, usuario nvarchar(255) COLLATE Modern_Spanish_CI_AS NOT NULL, contraseña nvarchar(255) COLLATE Modern_Spanish_CI_AS NOT NULL, empresaId int NULL, proveedorId int NULL, CONSTRAINT PK_01b020ce0e1202560b866cdfe87 PRIMARY KEY (id), CONSTRAINT FK_61b785eb9df199d0405c9190c0a FOREIGN KEY (proveedorId) REFERENCES aps.dbo.Proveedor(id));
